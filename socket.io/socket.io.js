...
(function (global, factory) {
    ...
    _proto2._create = function _create() {
      ...
      try {
        ...
        xhr.onreadystatechange = function () {
          var _a;
          if (xhr.readyState === 3) {
            (_a = _this5._opts.cookieJar) === null || _a === void 0 ? void 0 : _a.parseCookies(xhr.getResponseHeader("set-cookie"));
          }
  ...
  var RESERVED_EVENTS$1 = ["connect", "connect_error", "disconnect", "disconnecting", "newListener", "removeListener"];
  var protocol = 5;
  var PacketType;
  (function (PacketType) {
